...
if ($apiEndpoint == "getTopics") {
    $topics = get_topics($_SESSION["username"], $_SESSION["password"], $_SESSION['grOwnerId'], $_SESSION["level"]);
...
if ($apiEndpoint == "confirm_user" && isset($queryString[1])) {
    $code = $queryString[1];
...
if ($apiEndpoint == "send_validate_email" && isset($queryString[1])) {
    $email = $queryString[1];
